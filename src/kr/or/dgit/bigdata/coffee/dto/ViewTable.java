...
public class ViewTable {
	...
	public ViewTable(int rank, String cfCode, String cfName, int cfOne, int cfSell, int cfMargin, int salePrice,
			int addTax, int supplyPrice, int marginPrice) {
		super();
		this.rank = rank;
		this.cfCode = cfCode;
		this.cfName = cfName;
	...
	public String[] toArray() {
		return new String[] { rank + "", cfCode, cfName, cfOne + "", cfSell + "", cfMargin + "", salePrice + "",
