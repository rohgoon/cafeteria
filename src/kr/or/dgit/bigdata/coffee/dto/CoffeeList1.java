...
public class CoffeeList1 {
	...
	public CoffeeList1(String cfCode) {
		super();
		this.cfCode = cfCode;
	}


	public CoffeeList1(String cfCode, String cfName, int cfOne, int cfSell, int cfMargin, int salePrice, int addTax,
